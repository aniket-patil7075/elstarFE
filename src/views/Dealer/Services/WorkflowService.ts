...
export async function getAllEstimatesByPage(params: any) {
  try {
    const response = await axios.post(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/all-estimates-by-page`,
      params
    );
...
export async function getAllCountAccToStatus() {
  try {
    const response = await axios.get(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/get-all-counts`
    );
    return response.data; // Handle response (e.g., token, user data)
  } catch (error: any) {
    console.error("Get-All-Estimates error", error);
...
export async function apiAddNewEstimate(data: any) {
  try {
    const response = await axios.post(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/add-new-estimate`,
      data
    );
...
export async function apiUpdateEstimate(data: any, estimateId: any) {
  try {
    const response = await axios.put(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/update-estimate/${estimateId}`,
      data
    );
    ...
    if (error.response) {
      throw new Error(
        `Server Error: ${error.response.data.message || "Error in creating new Estimate"}`
      );
...
export async function getEstimateById(id: string) {
  try {
    const response = await axios.get(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/get-estimate/${id}`
    );
    return response.data; // Handle response (e.g., token, user data)
  } catch (error: any) {
    console.error("Get-All-Estimates error", error);
...
export async function apiSendEstimateEmail(data: any) {
  try {
    const response = await axios.post(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/send-estimate-mail`,
      data
    );
    //
    return response.data;
    ...
    if (error.response) {
      throw new Error(
        `Server Error: ${error.response.data.message || "Error in sending estimate email."}`
      );
    } else if (error.request) {
      // No response was received from the server
      throw new Error("Network Error: Unable to reach the server");
...
export async function apiUpdateEstimateStatus(
  estimateId: string,
  status: string
) {
  try {
    const response = await axios.put(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/update-order-status/${estimateId}`,
      { status: status }
    );
    //
    return response.data;
...
export async function apiUpdateCompleteEstimateDate(
  estimateId: string,
  payload: any
) {
  try {
    const response = await axios.put(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/update-estimate-dates/${estimateId}`,
      payload
    );
    //
    return response.data;
    ...
    if (error.response) {
      throw new Error(
        `Server Error: ${error.response.data.message || "Error in updating estimate complete date"}`
      );
    } else if (error.request) {
      // No response was received from the server
      throw new Error("Network Error: Unable to reach the server");
...
export async function apiSaveSignatureImage(data: any) {
  try {
    const response = await axios.post(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/service-authorization`,
      data
    );
    return response.data;
  } catch (error: any) {
...
export async function apiRecordPayment(data: any) {
  try {
    const response = await axios.post(
      `${API_BASE_URL}${apiPrefix}/dealer/workflow/record-payment`,
      data
    );
    return response.data;
  } catch (error: any) {
...
export async function apiStripepayment(data: any) {
  try {
    const response = await axios.post(
      `${API_BASE_URL}${apiPrefix}/create-checkout-session`,
      data
    );
    return response.data;
  } catch (error) {
...
export async function getStripePayment(params: any) {
  try {
    const response = await axios.get(
      `${API_BASE_URL}${apiPrefix}/session-status?session_id=${params}`
    );
    return response.data;
  } catch (error: any) {
    console.log(error);
...
export async function updateCustomerRemainingAmount(
  customerId: string,
  remainingAmount: number
) {
  try {
    const response = await axios.put(
      `${API_BASE_URL}${apiPrefix}/update-customer-remaining`,
      {
        customerId,
        remainingAmount,
      }
...
// export async function apiDeleteEstimate(estimateId: any) {
//     console.log(estimateId)
//   try {
//     const response = await axios.put(
//       `${API_BASE_URL}${apiPrefix}/dealer/workflow/delete-estimate/${estimateId}`
//     );
//     return response.data;
//   } catch (error: any) {
//     if (error.response) {
//       throw new Error(
//         `Server Error: ${error.response.data.message || "Error in deleting Estimate"}`
//       );
//     } else if (error.request) {
//       throw new Error("Network Error: Unable to reach the server");
//     } else {
...
export async function apiDeleteEstimate(estimateId:any) {
    console.log("Updating estimateFlag for:", estimateId);
    try {
      const response = await axios.put(
        `${API_BASE_URL}${apiPrefix}/dealer/workflow/delete-estimate/${estimateId}`,
        {} 
