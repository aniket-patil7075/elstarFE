...
const WorkAssignments = ({onAssignmentsChange}:{onAssignmentsChange:(data:any)=>void}) => {
  const [assignments, setAssignments] = useState({
    serviceWriter: false,
    laborForTechs: false,
    partsForTechs: false,
    promptForMissingAssignments: false,
  });
        ...
        <div className="w-full">
          <div className="my-5">
            ...
            <div className="my-2 w-3/4">
              ...
              <div className="mt-4 inline-flex flex-wrap xl:flex gap-3">
                <Button className="flex" onClick={() => handleToggle('serviceWriter')}>
                  <HiUser className="text-xl me-2" />
                  Service Writer
                </Button>
                <Button className="flex" onClick={() => handleToggle('laborForTechs')}>
                  {" "}
                  <HiClock className="text-xl me-2" /> Labor for Techs
                </Button>
                <Button className="flex" onClick={() => handleToggle('partsForTechs')}>
                  {" "}
          ...
          <div className="my-5">
            ...
            <div className="my-2 w-100 flex justify-between">
              ...
              <div>
                <Switcher onChange={() => handleToggle('promptForMissingAssignments')} />
              </div>
            </div>
          </div>
        </div>
