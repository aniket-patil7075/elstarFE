...
//   console.log("fees and reates : ", formData)
...
//               <Input name="orderLevelCap" 
//             value={formData.orderLevelCap} 
//             onChange={handleInputChange}  placeholder="0.00 $" size="md" />
//             </div>
//           </div>
//           <div className="my-5">
//             <p className="  text-black font-semibold">Service Value (%)</p>
//             <div className="my-2 w-3/4">
//               <Input  name="serviceValue" 
...
//             <div className="my-2 w-3/4">
//               <div className="my-2">
//                 <Checkbox onChange={(e) => onCheck(e.target.checked, "parts")}>
//                   Parts
//                 </Checkbox>
//               </div>
//               <div className="my-2">
//                 <Checkbox onChange={(e) => onCheck(e.target.checked, "labor")}>
//                   Labor
//                 </Checkbox>
//               </div>
//             </div>
...
//               </div>
//               <div className="my-2">
//                 <Checkbox onChange={(e) => onCheck(e.target.checked, "epa")}>
//                   EPA
//                 </Checkbox>
//               </div>
//               <div className="my-2">
//                 <Checkbox onChange={(e) => onCheck(e.target.checked, "shopSupplies")}>
//                   Shop Supplies
//                 </Checkbox>
//               </div>
//               <div className="my-2">
//                 <Checkbox onChange={(e) => onCheck(e.target.checked, "subContract")}>
//                   SubContract
//                 </Checkbox>
//               </div>
//             </div>
