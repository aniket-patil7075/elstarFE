...
const ProductList = () => {
  ...
  useEffect(() => {
    if (estimates && estimates.length > 0) {
      const grouped = estimates.reduce(
        (acc: Record<string, any[]>, estimate: any) => {
          ...
          {selectedValue === "columns" ? (
            ...
            <div className="h-[calc(100vh-170px)]">
              <div className="flex space-x-2 mb-2">
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    activeHeading === "parts" ? "text-blue-500" : "text-black"
                  }`}
                >
                  Parts on Orders
                </button>
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    activeHeading === "tires" ? "text-blue-500" : "text-black"
                  }`}
                >
                  Tires on Orders
                </button>
                <button
                  ...
                  className={`px-4 py-2 rounded ${
                    activeHeading === "returns" ? "text-blue-500" : "text-black"
                  }`}
                >
                  Part Returns
                </button>
              ...
              {activeHeading === "parts" ? (
                ...
                <div className="mt-4">{/* Add part return table */}</div>
              )}
            </div>
          ) : (
            <WorkflowTable />
