...
const AllInvoices = () => {
  ...
  // const generatePDF = () => {
  //   const doc = new jsPDF();
  //   doc.text("All Invoices Report", 14, 15);
  ...
  const handleGeneratePDF = () => {
    generatePDF(data, "All Invoices Report");
  };
  ...
  const handleGenerateExcel = async () => {
    ...
    try {
      ...
      XLSX.writeFile(workbook, "All_Invoices_Report.xlsx");
    } catch (error) {
    ...
    <div>
      <div className="mb-5 ms-2">
        <div className="lg:flex items-center justify-between mb-5">
          <h3 className="mb-4 lg:mb-0">All Invoices</h3>
