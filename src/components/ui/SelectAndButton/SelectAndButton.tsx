...
// Custom MenuList to include the "Add New" button
    ...
    return (
        <Component<Option, IsMulti, Group>
            ...
            components={{
                ...
                MenuList: (props) => (
                    <CustomMenuList {...props} addNewClick={addNewClick} addNewButtonLabel={addNewButtonLabel} />
                ), // Pass addNewClick to MenuList
                ...components,
            }}
            {...field}
            {...rest}
